...
from examples.composable.hypot.fused_square_add.fused.host import fused_square_add_then_sqrt, fused_square_add

REF_FN = lambda a, b: ttnn.add(ttnn.square(a), ttnn.square(b))
MAKO_KERNEL = fused_square_add
...
def main():
    ...
    try:
        ...
        print("Comparison to torch.square + torch.square")
        print()
        ...
        # Get torch reference
        torch_ref = torch.square(a) + torch.square(b)
